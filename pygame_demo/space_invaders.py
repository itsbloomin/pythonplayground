...
def main():
    ...
    def redraw_window():
        ...
        if lost:
            lost_label = main_font.render("You Lost!", 1, (200, 100, 50))
    ...
    while run:
        ...
        for enemy in enemies[:]:     # thats a copy of enemies[]
...
def main_menu():
    ...
    while run:
        WIN.blit(BG, (0,0))
        title_label = title_font.render("Press the mouse to begin...", 1, (200,100,50))
